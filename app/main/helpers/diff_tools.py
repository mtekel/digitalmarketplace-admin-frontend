...
class BaseDiffTool(object):
  ...
  def get_lines(self):
    ...
    for line in self.line_diff:
      ...
      if type == 'detail' and last_changed_line != None:
        ...
        if type == 'addition':
          ...
          last_changed_line = diff_line
        if type == 'unchanged':
          columns['revision_1'].append(DiffLine(line, 'revision_1', 'unchanged'))
          columns['revision_2'].append(DiffLine(line, 'revision_2', 'unchanged'))
    return columns
